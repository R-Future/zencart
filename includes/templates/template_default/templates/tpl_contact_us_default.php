...
<div class="input_title back"><label class="inputLabel" for="contactname"><?php echo ENTRY_NAME; ?></label></div>
<?php echo zen_draw_input_field('contactname', $name, ' size="40" id="contactname"') . '<span class="alert">' . ENTRY_REQUIRED_SYMBOL . '</span>'; ?>
<br class="clearBoth" />

<div class="input_title back"><label class="inputLabel" for="email-address"><?php echo ENTRY_EMAIL; ?></label></div>
<?php echo zen_draw_input_field('email', ($email_address), ' size="40" id="email-address"') . '<span class="alert">' . ENTRY_REQUIRED_SYMBOL . '</span>'; ?>
<br class="clearBoth" />

<div class="input_title back"><label for="enquiry"><?php echo ENTRY_ENQUIRY . '<span class="alert">' . ENTRY_REQUIRED_SYMBOL . '</span>'; ?></label></div>

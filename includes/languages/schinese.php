...
//columncenter bottom title
define('TEXT_DESCRIPTION','商品描述');
define('TEXT_SHIPPING','配送方式');
define('TEXT_REVIEW','用户评论');
define('TEXT_FAQ','客服问答');

//商品信息分类
define('ATTRIBUTES_OF_PRODUCT','商品属性');
define('PRICE_OF_PRODUCT','商品价格');
///////////////////////////////////////////////////////////
